...
function ImageModal({ open, handleClose, setPercent, setUploading }) {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle sx={{}}>이미지 보내기</DialogTitle>
      <DialogContent sx={{fontStyle:"-moz-initial"}}>jpeg, jpg, png, gif 파일만 가능합니다.</DialogContent>
      <DialogContent>
        <Input
          sx = {{marginTop:"-25px"}}
          margin="dense"
      ...
      <DialogActions>
        <Button sx={{}} onClick={handleClose}>취소</Button>
